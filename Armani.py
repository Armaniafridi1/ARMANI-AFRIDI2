...
#!/usr/bin/python
# coding=utf-8
# coded by : Armani-Afridi 
# https://m.me/DE4Th.HAcK3R
...
\033[1;97m            @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m           @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m          @@@••••••••••ARMANI•••••••@@@ \033[1;0m
\033[1;97m         @@@••••••••••AFRIDI  •••••••@@@ \033[1;0m
\033[1;97m        @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m       @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m      @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : Armani-Afridi
\033[1;93m➤\033[1;97m Github   : https://github.com/Armaniafridi1/ARMANI-AFRIDI2.git
\033[1;93m➤\033[1;97m Fb Id  : https://m.me/DE4Th.HAcK3R
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="Armani":
        os.system("clear")
        print logo
        print ("[+] Username : Armani (Correct)")
        passwordss = raw_input("\033[1;97m[+]\033[1;97m Password :\033[1;97m ")
        if passwordss =="Afridi":
            os.system("clear")
            print logo
            logging()
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : Armani\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : Afridi\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
	    ...
	    os.system('xdg-open https://m.me/DE4Th.HAcK3R ')
            time.sleep(1)
            tech_abm()
    else:
